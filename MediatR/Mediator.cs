namespace MediatR
{
    ...
    public class Mediator : IMediator
    {
        ...
        public UniTask<TResponse> Send<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken = default)
        {
            if (request == null)
            {
        ...
        protected virtual async UniTask PublishCore(IEnumerable<Func<INotification, CancellationToken, UniTask>> allHandlers, INotification notification, CancellationToken cancellationToken)
        {
